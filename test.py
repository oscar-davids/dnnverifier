...
if __name__ == "__main__":
    parser = ArgumentParser(description='"Test Demo of VQ')
    parser.add_argument('--model_path', default='models/mbqpmodel.pt', type=str,
                        help='model path (default: models/mbqpmodel.pt)')
    ...
    # quality prediction using VQModel
    model = VQModel()
