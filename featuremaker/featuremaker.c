...
PyMODINIT_FUNC PyInit_featuremaker(void)
{
    PyObject *m;

    m = PyModule_Create(&featuremaker);
    if (m == NULL)
        return NULL;
	...
	FeatureError = PyErr_NewException("feature.error", NULL, NULL);
...
int main(int argc, char *argv[])
{
    ...
    PyImport_AppendInittab("featuremaker", PyInit_featuremaker);
